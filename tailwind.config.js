    ...
    extend: {
      colors: {
        colors: {
          ...
          thirdBg: "#666666", // Special Bg Color
          buttonBg: "#e1b65f", // Button Bg Color
          buttonHover: "#f3df88", // Button Hover
          textDarkColor: "#131314", // Dark Text Color
          textDarkGray: "#383838", // Dark Text Color
          textLightColor: "#ffffff", // White Text Color
          secondTextColor: "#d8aa4c", // Special Text Color
          red: "#F27070", // Error Color
        },
      },
      backgroundImage: {
        "hero-bg": "url('/images/hero-bg-alhaq.webp')",
        "divider-bg": "url('/images/experience.webp')",
        "testimonial-bg": "url('/images/map-pattern.webp')",
        "divider2-bg": "url('/images/divider-bg.webp')",
