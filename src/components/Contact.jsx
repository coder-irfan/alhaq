...
function Contact() {
  ...
  const onSubmit = (data) => {
    ...
    const whatsappURL = `https://wa.me/93780331221?text=${message}`;
        ...
        <div className="space-y-10 sm:space-y-10 md:space-y-12 lg:space-y-14">
          <div className="text-center space-y-2 md:space-y-3">
            ...
            <p className="text-sm md:text-base text-colors-textDarkGray text-center max-w-2xl mx-auto">
              Interested in one of our projects? Contact us today to receive
              full details, availability, and professional guidance for your
              next property.
            </p>
          </div>
              ...
              <div className="space-y-6 lg:space-y-10">
                <div className="space-y-2 lg:space-y-3">
                  ...
                  <p className="text-sm md:text-base text-colors-textDarkGray">
                    Reach out to Alhaq for project availability, property
                    details, or investment opportunities. Our team is ready to
                    guide you with clear information and quick responses.
                  </p>
                </div>
                <div className="flex flex-col gap-6 lg:gap-8">
                  ...
                  <div className="flex flex-wrap gap-2 lg:gap-4 text-xl lg:text-2xl">
                    <a
                      href="https://www.instagram.com/alhaq.cc"
