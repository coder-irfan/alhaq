    ...
    <>
      ...
      >
        <div className="flex flex-col lg:flex-row justify-center lg:justify-between gap-8 lg:gap-10 pb-8">
          <div className="space-y-4 lg:space-y-5 max-w-md lg:max-w-xs flex flex-col items-start justify-start ">
            ...
            <p className="text-sm lg:text-base">
              Alhaq Construction delivers reliable residential and commercial
              buildings across Afghanistan, focusing on quality, safety, and
              timely completion.
            </p>
          </div>

          <div className="flex gap-12 sm:gap-28 md:gap-36 lg:gap-10 xl:gap-28">
          ...
          <div className="flex flex-col md:flex-row gap-10 sm:gap-28 md:gap-36 lg:gap-10 xl:gap-28">
            <div className="space-y-2 lg:space-y-5">
              <h3 className="text-h3 font-medium text-colors-textDarkGray">
                Support
              </h3>
            ...
            <div className="space-y-2 lg:space-y-5">
              ...
              <ul className="space-y-2 lg:space-y-4 text-sm xl:text-base max-w-sm">
                <li className="flex items-center gap-2">
                  <FaPhone className="lg:text-lg text-colors-buttonBg" />
                  <a
                ...
                <li className="flex items-center gap-2">
                  <FaMailBulk className="lg:text-lg text-colors-buttonBg" />
                  <a
                    href="mailto:alhaqrahmati.cc@gmail.com"
                    className="text-sm md:text-base hover:text-colors-secondTextColor transition-colors duration-300"
                  >
                    alhaqrahmati.cc@gmail.com
                  </a>
                </li>
                <li className="flex items-center gap-2">
                  <FaSearchLocation className="text-lg lg:text-2xl text-colors-buttonBg" />
                  <a href="">
                    2 Street, Taimani Porject, Near Afghan-Turk Girls High
                    School
                  </a>
                </li>
              </ul>
